...
const MOCK_PROFILES = [
  { id: "business_lecture", name: "Keira", description: "Business & Management lectures", stage_count: 3, stages: ["Clean & Structure", "Strategic Analysis", "Cheat Sheet"] },
  { id: "social_work_lecture", name: "Kate", description: "Social Work lectures & seminars", stage_count: 3, stages: ["Cleaning", "Statutory Analysis", "QA & Cheat Sheet"] },
  { id: "meeting", name: "Meeting", description: "Standard meeting transcription", stage_count: 1, stages: ["Format"] },
  { id: "supervision", name: "Supervision", description: "Supervision session notes", stage_count: 1, stages: ["Format"] },
  { id: "braindump", name: "Braindump", description: "Quick voice note capture", stage_count: 1, stages: ["Format"] },
];

const MOCK_JOBS = [
  { id: "j1", profile_id: "business_lecture", filename: "uploads/business_lecture/2026-02-11-Week8_Strategy.mp3", status: "COMPLETE", current_stage: "complete", created_at: "2026-02-11T14:30:00", completed_at: "2026-02-11T14:38:22", error: null, cost_estimate: 0.042 },
  { id: "j2", profile_id: "social_work_lecture", filename: "uploads/social_work/2026-02-11-SWK_Seminar_3.m4a", status: "PROCESSING", current_stage: "formatting", created_at: "2026-02-11T15:10:00", completed_at: null, error: null, cost_estimate: 0.018 },
  { id: "j3", profile_id: "business_lecture", filename: "uploads/business_lecture/2026-02-10-Leadership_Models.wav", status: "COMPLETE", current_stage: "complete", created_at: "2026-02-10T09:15:00", completed_at: "2026-02-10T09:24:11", error: null, cost_estimate: 0.038 },
  { id: "j4", profile_id: "meeting", filename: "uploads/meeting/2026-02-10-Team_Standup.mp3", status: "FAILED", current_stage: "transcription", created_at: "2026-02-10T11:00:00", completed_at: null, error: "Groq API timeout after 3 retries", cost_estimate: 0.002 },
  { id: "j5", profile_id: "social_work_lecture", filename: "uploads/social_work/2026-02-09-Ethics_Workshop.m4a", status: "COMPLETE", current_stage: "complete", created_at: "2026-02-09T16:45:00", completed_at: "2026-02-09T16:53:40", error: null, cost_estimate: 0.035 },
  { id: "j6", profile_id: "braindump", filename: "uploads/braindump/2026-02-09-Quick_Thought.ogg", status: "COMPLETE", current_stage: "complete", created_at: "2026-02-09T08:20:00", completed_at: "2026-02-09T08:21:05", error: null, cost_estimate: 0.003 },
];

const MOCK_HEALTH = { status: "healthy", checks: { api: true, database: true, disk_space: true } };
const MOCK_READY = { ready: true, checks: { api: true, groq: true, deepseek: true, huggingface: true } };
...
function CreateProfileModal({ onClose, onSave }) {
  ...
  const [stages, setStages] = useState([
    { name: "Clean & Format", model: "deepseek-chat", temperature: 0.3, max_tokens: 4096, prompt: "" },
  ]);
  ...
  const addStage = () => {
    setStages([...stages, { name: "", model: "deepseek-chat", temperature: 0.3, max_tokens: 4096, prompt: "" }]);
  };
